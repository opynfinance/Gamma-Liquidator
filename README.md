...
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| BOT_MINIMUM_ETHER_BALANCE    | Minimum balance of Ether the bot's wallet should have to run. Denominated in wei. (Default: 0)                                                                                                                                                                                        |
...
| DERIBIT_PRICE_MULTIPLIER     | How much to multiply the Deribit best ask price of a given option by when determing liquidation profitability. (Default: 1.0)                                                                                                                                                         |
...
| GAS_PRICE_MULTIPLIER         | How much to multiply the `rapid` [GasNow](https://www.gasnow.org/) gas price by when sending transactions. Multiplied against the on-chain median gas price as a fallback. (Default: 1.0)                                                                                             |
